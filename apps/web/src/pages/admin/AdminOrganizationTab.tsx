...
export function AdminOrganizationTab() {
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      {canDelete && (
        <section className="space-y-3 rounded-lg border border-[hsl(var(--destructive))]/40 bg-[hsl(var(--card))] p-6">
          <h3 className="flex items-center gap-2 text-lg font-brand text-[hsl(var(--destructive))]">
            <ShieldAlert className="h-5 w-5" />
            Danger Zone
          </h3>
          <p className="text-sm text-[hsl(var(--muted-foreground))]">
            Deleting the organization removes its songs, set lists, events, media, and memberships. There is no undo.
          </p>
          <button
            type="button"
